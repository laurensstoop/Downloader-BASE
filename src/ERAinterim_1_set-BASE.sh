...
for Y in $(seq 1979 2018);do  #1985 2005 
    ...
    cdo -b 64 select,name=ssr /media/DataDrive/ERAinterim/origin/ERAinterim-EU_${Y}.nc $stage/temp_${Y}.nc
    # Select the timestep
    ...
    ncatted -a history,global,d,, -h $stage/ERAinterim-EU_ssrd_$Y.nc /media/DataDrive/ERAinterim-EU_BASE/ERAinterim-EU_ssrd_$Y.nc
    # Clean up 
    rm $stage/temp_*$Y.nc
    rm $stage/temp_$Y*.nc
...
for Y in $(seq 1979 2018);do  #1979 2018 
    # Convert from Grib2 data to netcdf
    cdo -b 64 select,name=t2m /media/DataDrive/ERAinterim/origin/ERAinterim-EU_${Y}.nc $stage/temp_${Y}.nc
    # Set the correct name
    ...
    ncatted -a history,global,d,, -h $stage/ERAinterim-EU_t2m_$Y.nc /media/DataDrive/ERAinterim-EU_BASE/ERAinterim-EU_t2m_$Y.nc
    # Clean up 
    rm $stage/temp_$Y.nc
...
for Y in $(seq 1979 2018);do  #1979 2018 
    # Convert from Grib2 data to netcdf
    cdo -b 64 select,name=u10,v10 /media/DataDrive/ERAinterim/origin/ERAinterim-EU_${Y}.nc $stage/temp_${Y}.nc
    # Set the correct name
    ...
    ncatted -a history,global,d,, -h $stage/ERAinterim-EU_wspd_$Y.nc /media/DataDrive/ERAinterim-EU_BASE/ERAinterim-EU_wspd_$Y.nc
    # Clean up 
    rm $stage/temp_$Y.nc
