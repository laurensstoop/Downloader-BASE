...
for Y in $(seq 2011 2011);do  #1979 2010 
    for M in $months ; do
        ...
        cdo -f nc copy -sellonlatbox,-31,74.25,34.5,80 /media/DataFiles/CFSv2/origin/dswsfc.gdas.$Y$M.grb2 /media/DataStager1/TEMP/CFSR/dswsfc.gdas.$Y$M.nc
    ...
    ncatted -a history,global,d,, -h /media/DataStager1/TEMP/CFSR/CFSR-EU_ssrd_$Y.nc /media/DataFiles/CFSR-EU_BASE/CFSR-EU_ssrd_$Y.nc
done
...
for Y in $(seq 2011 2011);do  #1979 2010 
    for M in $months ; do
        # Convert from Grib2 data to netcdf
        cdo -f nc copy -sellonlatbox,-31,74.25,34.5,80 /media/DataFiles/CFSv2/origin/tmp2m.gdas.$Y$M.grb2 /media/DataStager1/TEMP/CFSR/tmp2m.gdas.$Y$M.nc
        # Fix the variables for the radiation
    ...
    ncatted -a history,global,d,, -h /media/DataStager1/TEMP/CFSR/CFSR-EU_t2m_$Y.nc /media/DataFiles/CFSR-EU_BASE/CFSR-EU_t2m_$Y.nc
done
...
for Y in $(seq 2011 2011);do  #1979 2010 
    for M in $months ; do
        # Convert from Grib2 data to netcdf
        cdo -f nc copy -sellonlatbox,-31,74.25,34.5,80 /media/DataFiles/CFSv2/origin/wnd10m.gdas.$Y$M.grb2 /media/DataStager1/TEMP/CFSR/wnd10m.gdas.$Y$M.nc
        # Fix the variables for the radiation
    ...
    ncatted -a history,global,d,, -h /media/DataStager1/TEMP/CFSR/CFSR-EU_wspd_$Y.nc /media/DataFiles/CFSR-EU_BASE/CFSR-EU_wspd_$Y.nc
done
