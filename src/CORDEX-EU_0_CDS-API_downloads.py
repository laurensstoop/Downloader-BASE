...
EC-Earth: 
    ...
    HIRHAM  [r3i1p1]    (1951 -- 2100) {{{!!! DO THIS NEXT !!!}}}
...
GCM_model = 'ichec_ec_earth'  # ichec_ec_earth, mohc_hadgem2_es
RCM_model = 'dmi_hirham5' # smhi_rca4, knmi_racmo22e, dmi_hirham5
ENSEMBLE_member = 'r3i1p1'


# define the storage location
file_path = '/media/DataGate3/CORDEX-EU/origin_EC_HIRHAM/'
