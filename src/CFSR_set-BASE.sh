...
for Y in $(seq 1979 2010);do  #1979 2010 
    for M in $months ; do
        ...
        cdo -f nc copy -sellonlatbox,-31,74.25,34.5,80 /media/stoop/DataFiles/CFSR/origin/dswsfc.gdas.$Y$M.grb2 /media/stoop/DataStager/TEMP/CFSR/dswsfc.gdas.$Y$M.nc
    ...
    ncatted -a history,global,d,, -h /media/stoop/DataStager/TEMP/CFSR/CFSR-EU_ssrd_$Y.nc /media/stoop/DataFiles/CFSR/CFSR-EU_BASE/CFSR-EU_ssrd_$Y.nc
    # Clean up 
    rm /media/stoop/DataFiles/CFSR/origin/dswsfc.gdas.$Y*.grb2
    rm /media/stoop/DataStager/TEMP/CFSR/dswsfc.gdas.$Y*.nc
    rm /media/stoop/DataStager/TEMP/CFSR/CFSR-EU_ssrd_$Y*.nc
    rm /media/stoop/DataStager/TEMP/CFSR/CFSR-EU_ssrd_$Y.nc
done
...
for Y in $(seq 1979 2010);do  #1979 2010 
    for M in $months ; do
        # Convert from Grib2 data to netcdf
        cdo -f nc copy -sellonlatbox,-31,74.25,34.5,80 /media/stoop/DataFiles/CFSR/origin/tmp2m.gdas.$Y$M.grb2 /media/stoop/DataStager/TEMP/CFSR/tmp2m.gdas.$Y$M.nc
        # Fix the variables for the radiation
    ...
    ncatted -a history,global,d,, -h /media/stoop/DataStager/TEMP/CFSR/CFSR-EU_t2m_$Y.nc /media/stoop/DataFiles/CFSR/CFSR-EU_BASE/CFSR-EU_t2m_$Y.nc
    # Clean up 
    rm /media/stoop/DataFiles/CFSR/origin/tmp2m.gdas.$Y*.grb2
    rm /media/stoop/DataStager/TEMP/CFSR/tmp2m.gdas.$Y*.nc
    rm /media/stoop/DataStager/TEMP/CFSR/CFSR-EU_t2m_$Y*.nc
    rm /media/stoop/DataStager/TEMP/CFSR/CFSR-EU_t2m_$Y.nc
done
...
for Y in $(seq 1979 2010);do  #1979 2010 
    for M in $months ; do
        # Convert from Grib2 data to netcdf
        cdo -f nc copy -sellonlatbox,-31,74.25,34.5,80 /media/stoop/DataFiles/CFSR/origin/wnd10m.gdas.$Y$M.grb2 /media/stoop/DataStager/TEMP/CFSR/wnd10m.gdas.$Y$M.nc
        # Fix the variables for the radiation
    ...
    ncatted -a history,global,d,, -h /media/stoop/DataStager/TEMP/CFSR/CFSR-EU_wspd_$Y.nc /media/stoop/DataFiles/CFSR/CFSR-EU_BASE/CFSR-EU_wspd_$Y.nc
    # Clean up 
    rm /media/stoop/DataFiles/CFSR/origin/wnd10m.gdas.$Y*.grb2
    rm /media/stoop/DataStager/TEMP/CFSR/wnd10m.gdas.$Y*.nc
    rm /media/stoop/DataStager/TEMP/CFSR/CFSR-EU_wspd_$Y*.nc
    rm /media/stoop/DataStager/TEMP/CFSR/CFSR-EU_wspd_$Y.nc
done
